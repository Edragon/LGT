...
volatile unsigned char 	COGAS		@ 0x09A;
volatile unsigned char 	L_COGAS		@ 0x09A;
volatile bit COGASS0                @ ((unsigned)&COGAS*8)+4;
volatile bit COGASS1                @ ((unsigned)&COGAS*8)+5;
volatile bit COGASS2                @ ((unsigned)&COGAS*8)+6;
volatile bit COGASE                 @ ((unsigned)&COGAS*8)+7;
