...
#ifdef __XC8
#define __L_CONFIG(x)	__PROG_CONFIG(1, (x))
#else
...
volatile bit SPIC2X		@((unsigned)&SPSR*8)+0;
#ifndef _LIB_BUILD
volatile union {
	struct {
		unsigned	SPIIF	: 1;
...
volatile bit T1IS		@((unsigned)&TCCR*8)+0;
...
volatile bit ECP1_CE3	@((unsigned)&ECP1CR0*8)+5;
volatile bit ECP1_PE3	@((unsigned)&ECP1CR0*8)+4;
volatile bit ECP1_CE2	@((unsigned)&ECP1CR0*8)+3;
volatile bit ECP1_PE2	@((unsigned)&ECP1CR0*8)+2;
volatile bit ECP1_CE1	@((unsigned)&ECP1CR0*8)+1;
volatile bit ECP1_PE1	@((unsigned)&ECP1CR0*8)+0;
#ifndef _LIB_BUILD
volatile union {
    struct {
...
volatile bit ECP2_CE4	@((unsigned)&ECP2CR0*8)+7;
volatile bit ECP2_PE4	@((unsigned)&ECP2CR0*8)+6;
volatile bit ECP2_CE3	@((unsigned)&ECP2CR0*8)+5;
volatile bit ECP2_PE3	@((unsigned)&ECP2CR0*8)+4;
volatile bit ECP2_CE2	@((unsigned)&ECP2CR0*8)+3;
volatile bit ECP2_PE2	@((unsigned)&ECP2CR0*8)+2;
volatile bit ECP2_CE1	@((unsigned)&ECP2CR0*8)+1;
volatile bit ECP2_PE1	@((unsigned)&ECP2CR0*8)+0;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	ECP2_CE4	: 1;
