...
//*******************************************************************************
// set TC0's Clock source

// set TC0's Waveform Generation Mode
#define TC0_WGM		TC0_WGM_FPWMOCA

// set TC0's Compare Output Mode
#define TC0_COMA	TC0_COM_CLR_MACH
#define TC0_COMB	TC0_COM_CLR_MACH

// set TC0's Interrupts
#define TC0_TOV0	1
#define TC0_OCF0A	0
#define TC0_OCF0B	0
...
void tc0_init(void)
{
	...
	TCCR0A = (TC0_COMA << COM0A0) | (TC0_COMB << COM0B0);
